...
CoarsePanel::CoarsePanel () : ToolPanel (), oldhflip(false), oldvflip(false)
{
    ...
    Gtk::Image* rotateli = Gtk::manage (new RTImage ("rotate-left-90.svg"));
    ...
    Gtk::Image* rotateri = Gtk::manage (new RTImage ("rotate-right-90.svg"));
    ...
    Gtk::Image* fliphi = Gtk::manage (new RTImage ("flip-horizontal.svg"));
    hflip = Gtk::manage (new Gtk::ToggleButton ());
    hflip->add (*fliphi);
    hflip->set_relief(Gtk::RELIEF_NONE);
    pack_start (*hflip);

    Gtk::Image* flipvi = Gtk::manage (new RTImage ("flip-vertical.svg"));
