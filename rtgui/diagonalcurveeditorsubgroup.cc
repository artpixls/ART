...
DiagonalCurveEditorSubGroup::DiagonalCurveEditorSubGroup (CurveEditorGroup* prt, Glib::ustring& curveDir, float curvesRatio) : CurveEditorSubGroup(curveDir)
{
    ...
    initButton(*editPointCustom, Glib::ustring("edit-point.svg"), Gtk::ALIGN_START, false, "CURVEEDITOR_EDITPOINT_HINT");
    editCustom = Gtk::manage (new Gtk::ToggleButton());
    initButton(*editCustom, Glib::ustring("crosshair-node-curve.svg"), Gtk::ALIGN_START, false, "EDIT_PIPETTE_TOOLTIP");
    editCustom->hide();
    copyCustom = Gtk::manage (new Gtk::Button ());
    initButton(*copyCustom, Glib::ustring("copy.svg"), Gtk::ALIGN_END, true);
    pasteCustom = Gtk::manage (new Gtk::Button ());
    initButton(*pasteCustom, Glib::ustring("paste.svg"), Gtk::ALIGN_END, false);
    loadCustom = Gtk::manage (new Gtk::Button ());
    initButton(*loadCustom, Glib::ustring("folder-open.svg"), Gtk::ALIGN_END, false);
    saveCustom = Gtk::manage (new Gtk::Button ());
    initButton(*saveCustom, Glib::ustring("save.svg"), Gtk::ALIGN_END, false);
    ...
    initButton(*editPointNURBS, Glib::ustring("edit-point.svg"), Gtk::ALIGN_START, false, "CURVEEDITOR_EDITPOINT_HINT");
    editNURBS = Gtk::manage (new Gtk::ToggleButton());
    initButton(*editNURBS, Glib::ustring("crosshair-node-curve.svg"), Gtk::ALIGN_START, false, "EDIT_PIPETTE_TOOLTIP");
    editNURBS->hide();
    copyNURBS = Gtk::manage (new Gtk::Button ());
    initButton(*copyNURBS, Glib::ustring("copy.svg"), Gtk::ALIGN_END, true);
    pasteNURBS = Gtk::manage (new Gtk::Button ());
    initButton(*pasteNURBS, Glib::ustring("paste.svg"), Gtk::ALIGN_END, false);
    loadNURBS = Gtk::manage (new Gtk::Button ());
    initButton(*loadNURBS, Glib::ustring("folder-open.svg"), Gtk::ALIGN_END, false);
    saveNURBS = Gtk::manage (new Gtk::Button ());
    initButton(*saveNURBS, Glib::ustring("save.svg"), Gtk::ALIGN_END, false);
    ...
    initButton(*editParam, Glib::ustring("crosshair-node-curve.svg"), Gtk::ALIGN_START, false, "EDIT_PIPETTE_TOOLTIP");
    editParam->hide();
    copyParam = Gtk::manage (new Gtk::Button ());
    initButton(*copyParam, Glib::ustring("copy.svg"), Gtk::ALIGN_END, true);
    pasteParam = Gtk::manage (new Gtk::Button ());
    initButton(*pasteParam, Glib::ustring("paste.svg"), Gtk::ALIGN_END, false);
    loadParam = Gtk::manage (new Gtk::Button ());
    initButton(*loadParam, Glib::ustring("folder-open.svg"), Gtk::ALIGN_END, false);
    saveParam = Gtk::manage (new Gtk::Button ());
    initButton(*saveParam, Glib::ustring("save.svg"), Gtk::ALIGN_END, false);
